...
/**
 * {@link ContentProvider} for AbsinthianaInventory app.
 */
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.absinthianainventory/inventory" will map to the
        ...
        // For example, "content://com.example.android.absinthianainventory/inventory/3" matches, but
        // "content://com.example.android.absinthianainventory/inventory" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.example.android.absinthianainventory/inventory/3",
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String productPic = values.getAsString(ItemEntry.COLUMN_ITEM_IMAGE);
        if (productPic == null) {
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ItemEntry#COLUMN_SUPPLIER_PHONE} key is present,
        ...
        // If the {@link ItemEntry#COLUMN_SUPPLIER_EMAIL} key is present,
        // check that the supplier email address value is not null.
